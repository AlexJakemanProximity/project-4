...
pre_social_login = Signal(["request", "sociallogin"])

# Sent after a user connects a social account to a their local account.
social_account_added = Signal(["request", "sociallogin"])
...
social_account_updated = Signal(["request", "sociallogin"])

# Sent after a user disconnects a social account from their local
# account.
social_account_removed = Signal(["request", "socialaccount"])
